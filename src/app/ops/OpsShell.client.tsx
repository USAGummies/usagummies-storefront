...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/ops/finance/vendor-margin", label: "Vendor Margin", icon: "\u{1F4D0}", roles: ["admin", "employee", "investor", "partner"] },
      { href: "/ops/finance/off-grid", label: "Off-Grid Quotes", icon: "⚠️", roles: ["admin", "employee"] },
      { href: "/ops/ledger", label: "Rene's Ledger", icon: "\u{1F4BC}", roles: ["admin", "employee"] },
      ...
      { href: "/ops/sales", label: "Sales Command", icon: "\u{1F4C8}", roles: ["admin", "employee", "investor", "partner"] },
      { href: "/ops/sales/tour", label: "Sales Tour", icon: "\u{1F5FA}\uFE0F", roles: ["admin", "employee"] },
      { href: "/ops/sales/prospects/day1", label: "Day 1 Prospects", icon: "\u{1F4CB}", roles: ["admin", "employee"] },
      { href: "/ops/sales/pipeline-drift", label: "Pipeline Drift", icon: "\u{1F9ED}", roles: ["admin", "employee"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/ops/vendors/new", label: "Vendor Onboarding", icon: "\u{1F3ED}", roles: ["admin", "employee"] },
      ...
      { href: "/ops/sample-queue", label: "Sample Queue", icon: "\u{1F4E6}", roles: ["admin", "employee"] },
      { href: "/ops/agents/status", label: "Agent Status", icon: "\u{1F916}", roles: ["admin", "employee"] },
      { href: "/ops/agents/health", label: "Agent Health", icon: "\u{1F9D1}‍⚕️", roles: ["admin", "employee"] },
      { href: "/ops/agents/graduation", label: "Agent Graduation", icon: "\u{1F393}", roles: ["admin", "employee"] },
      { href: "/ops/email-agents", label: "Email Agents", icon: "✉️", roles: ["admin", "employee"] },
