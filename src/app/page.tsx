      ...
      <section className={`${styles.scene} ${styles.sceneBundle} home-purchase-stage home-hero-theme`} data-zone="BUNDLE">
        ...
        <div className={styles.sceneContent}>
          <div className="mx-auto max-w-6xl px-4 pb-1 sm:pb-1.5 lg:pb-2">
            <div className="mt-0">
              <div id="hero-primary-cta" className="atomic-buy americana-panel heritage-paper">
                ...
                <div className="atomic-buy__header">
                  <div className="atomic-buy__headerMain">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2">
                      <span className="usa-stamp usa-stamp--navy">Standards</span>
                      <div className="text-[12px] font-semibold text-[var(--muted)]">
                        No artificial dyes. Real ingredients. Made at home. That’s the deal.
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative grid gap-1 lg:gap-2 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div className="order-2 relative lg:order-1">
              <div className="relative z-10 space-y-0.5">
                ...
                <div className="mt-2 proof-bar">
                  <span className="proof-chip"><b>Made in the USA</b> • packed in FDA-registered facilities</span>
                  <span className="proof-chip"><b>No artificial dyes</b> • colored naturally</span>
                  <span className="proof-chip"><b>Ships fast</b> • satisfaction guaranteed</span>
                </div>
