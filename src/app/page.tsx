  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-6 sm:py-8 lg:py-10">
          <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-[0.28em] text-white/70">
              ...
              <div className="grid gap-1 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/15 bg-white/10 px-3 py-2">
                  ...
                  <div className="mt-0.5 text-base font-black text-white">8 bags</div>
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 px-3 py-2">
                  ...
                  <div className="mt-0.5 text-base font-black text-white">5+ bags</div>
                ...
                <div className="rounded-2xl border border-white/15 bg-white/10 px-3 py-2">
                  ...
                  <div className="mt-0.5 text-base font-black text-white">Dye-free</div>
              ...
              <div className="rounded-2xl border border-white/15 bg-white/5 px-3 py-1.5 flex flex-wrap items-center gap-3">
                <span className="text-xs font-semibold text-white">★★★★★ Verified buyer reviews</span>
                <span className="text-[11px] text-white/70">Real customers. Real bundles.</span>
                <Link
                  href={`/products/${handle}`}
                  className="text-[11px] text-white/70 underline underline-offset-4 hover:text-white focus-ring"
                >
      ...
      <section className="relative overflow-hidden bg-[var(--navy)] text-white">
        ...
        />
        <div className="relative mx-auto max-w-6xl px-4 py-4 lg:py-6 reveal-up">
          <ReviewsSection />
        </div>
      </section>

      <section className="bg-[var(--navy)]">
        <div className="mx-auto max-w-6xl px-4 py-4 lg:py-6 reveal-up">
          <div className="relative overflow-hidden rounded-[32px] border border-[rgba(199,54,44,0.24)] bg-[var(--surface-strong)] p-4 shadow-[0_22px_60px_rgba(7,12,20,0.45)] sm:p-5">
            <div className="relative space-y-4">
              <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
                <div className="space-y-3">
                  ...
                  <div className="grid gap-2 sm:grid-cols-3">
                    {storySteps.map((step, idx) => (
                      <div
                        key={step.title}
                        className="rounded-2xl border border-[rgba(13,28,51,0.12)] bg-[var(--surface)] p-2 shadow-[0_10px_24px_rgba(15,27,45,0.08)]"
                      >
                ...
                <div className="space-y-2">
                  <div className="relative overflow-hidden rounded-3xl border border-[rgba(13,28,51,0.12)] bg-[var(--surface)] p-3 shadow-[0_18px_44px_rgba(15,27,45,0.14)]">
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                {whyCards.map((card) => (
                  <div
                    key={card.title}
                    className="relative overflow-hidden rounded-2xl border border-[rgba(13,28,51,0.12)] bg-[var(--surface)] p-2 shadow-[0_12px_28px_rgba(15,27,45,0.1)] transition-transform duration-200 hover:-translate-y-1"
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(13,28,51,0.06)]">
                        {card.icon}
                      </div>
      ...
      <section className="bg-[var(--navy)]">
        <div className="mx-auto max-w-6xl px-4 py-4 lg:py-6 reveal-up">
          <div className="relative overflow-hidden rounded-3xl border border-[rgba(199,54,44,0.22)] bg-[var(--surface-strong)] p-4 shadow-[0_20px_54px_rgba(7,12,20,0.4)]">
            <div className="grid gap-3 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <form className="flex flex-wrap gap-3 items-center rounded-2xl border border-[rgba(13,28,51,0.12)] bg-[var(--surface)] p-2">
                <input
                  type="email"
                  name="email"
