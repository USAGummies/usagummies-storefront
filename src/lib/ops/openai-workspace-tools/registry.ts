...
export const OPENAI_WORKSPACE_TOOLS: readonly OpenAIWorkspaceTool[] = Object.freeze([
  ...
  },
  {
    ...
    name: "Agent packs",
    description:
      "Read the operator-facing pack view over existing agent contracts. Packs are read-models, not new agents.",
    mode: "read",
    status: "planned",
    audience: "Ben",
    readOnly: true,
    ...
    blocker: "Agent-pack work is present in the active worktree but not part of this Phase 0 registry commit.",
    safetyNotes: READ_ONLY_NOTES,
  },
  {
    ...
    description:
      "Search captured doctrine, corrections, and transcripts once the operating-memory API is finalized.",
    mode: "read",
    status: "planned",
    audience: "Ben",
    readOnly: true,
    requiresHumanApproval: false,
    blocker: "Operating-memory routes are active worktree changes; expose only after the drift/redaction contract lands.",
    safetyNotes: READ_ONLY_NOTES,
  },
  {
