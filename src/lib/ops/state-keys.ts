...
export const STATE_KEYS = {
  ...
  "abra:surfaced_emails": "abra-surfaced-emails.json",
  "abra:reconciliation_posted_dates": "abra-reconciliation-posted-dates.json",
  "abra:signal_posts": "abra-signal-posts.json",
  "abra:open_po_summary": "abra-open-po-summary.json",
  ...
  "operator:bank_feed_sweep:post_lock": "operator-bank-feed-sweep-post.lock",
  "operator:bank_feed_sweep:last_posted": "operator-bank-feed-sweep-last-posted.json",
  "operator:financial_import_plans": "operator-financial-import-plans.json",
  "operator:proactive_alert_scan:lock": "operator-proactive-alert-scan.lock",
  ...
  "operator:step:vendor_payments:summary": "operator-step-vendor-payments-summary.json",
  "operator:step:inventory:last_run": "operator-step-inventory-last-run.json",
  "operator:step:inventory:summary": "operator-step-inventory-summary.json",
  "operator:step:reconciliation:last_run": "operator-step-reconciliation-last-run.json",
  "operator:step:reconciliation:summary": "operator-step-reconciliation-summary.json",
  "operator:step:wholesale:last_run": "operator-step-wholesale-last-run.json",
  "operator:step:wholesale:summary": "operator-step-wholesale-summary.json",
  "operator:step:po_capture:last_run": "operator-step-po-capture-last-run.json",
  "operator:step:po_capture:summary": "operator-step-po-capture-summary.json",
  "operator:step:task_execution:last_run": "operator-step-task-execution-last-run.json",
  "operator:step:unified_revenue:last_run": "operator-step-unified-revenue-last-run.json",
  "operator:step:unified_inventory:last_run": "operator-step-unified-inventory-last-run.json",
  "operator:step:open_po_tracker:last_run": "operator-step-open-po-tracker-last-run.json",
  "operator:step:open_po_tracker:summary": "operator-step-open-po-tracker-summary.json",
  "operator:step:email_surface:last_run": "operator-step-email-surface-last-run.json",
