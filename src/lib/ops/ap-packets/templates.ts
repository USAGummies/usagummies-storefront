...
export const USA_GUMMIES_BASE_TEMPLATE: ApPacketTemplate = {
  ...
  replyDraftSkeleton: {
    ...
    bodyTemplate: [
      ...
      "",
      "--",
      "Pricing terms: Launch pricing is locked for the opening order and current replenishment window. Future reorder pricing remains subject to material changes in ingredient, packaging, production, freight, or fuel costs, with notice before adjustment.",
      "",
      "Best,",
      "Ben Stutman",
      "USA Gummies",
