/**
 * Engine Schedule Registry — central configuration for all 80 agents.
 *
...
export const ENGINE_REGISTRY: EngineConfig[] = [
  {
    ...
    agents: [
      ...
      { key: "agent10", name: "Self-Heal Monitor", schedule: "Every 30 min" },
  ...
  },
  {
    ...
    agents: [
      ...
      { key: "S9", name: "Self-Heal Monitor", schedule: "Every 30 min" },
    ],
  },
  {
    id: "dtc",
    ...
    agents: [
      ...
      { key: "D10", name: "Self-Heal Monitor", schedule: "Every 30 min" },
    ],
  },
  {
    id: "supply-chain",
    ...
    agents: [
      ...
      { key: "SC8", name: "Self-Heal Monitor", schedule: "Every 30 min" },
    ],
  },
  {
    id: "revenue-intel",
  ...
  },
  {
    ...
    agents: [
      ...
      { key: "AR1", name: "Email Drafter Eval (Auto Research)", schedule: "Weekly Sun 02:00" },
      { key: "AR2", name: "Financial Processor Eval (Auto Research)", schedule: "Weekly Sun 02:30" },
      { key: "AR3", name: "Slack Processor Eval (Auto Research)", schedule: "Weekly Sun 03:00" },
      { key: "AR4", name: "Weekly Digest Eval (Auto Research)", schedule: "Weekly Sun 03:30" },
      { key: "AR5", name: "Strategy Orchestrator Eval (Auto Research)", schedule: "Weekly Sun 04:00" },
      { key: "AR6", name: "Blog Drafter Eval (Auto Research)", schedule: "Weekly Sun 04:30" },
      { key: "AR7", name: "Social Responder Eval (Auto Research)", schedule: "Weekly Sun 05:00" },
      { key: "AR8", name: "Social Post Generator Eval (Auto Research)", schedule: "Weekly Sun 05:30" },
      { key: "AR9", name: "Morning Brief Eval (Auto Research)", schedule: "Weekly Sun 06:00" },
      { key: "AR10", name: "Anomaly Detector Eval (Auto Research)", schedule: "Weekly Sun 06:30" },
      { key: "AR11", name: "Pipeline Intel Eval (Auto Research)", schedule: "Weekly Sun 07:00" },
      { key: "AR12", name: "Operational Signals Eval (Auto Research)", schedule: "Weekly Sun 07:30" },
      { key: "AR13", name: "B2B Outreach Eval (Auto Research)", schedule: "Weekly Sun 08:00" },
      { key: "AR14", name: "B2B Reply Classifier Eval (Auto Research)", schedule: "Weekly Sun 08:30" },
      { key: "AR15", name: "B2B Forecaster Eval (Auto Research)", schedule: "Weekly Mon 02:00" },
      { key: "AR16", name: "B2B Deal Tracker Eval (Auto Research)", schedule: "Weekly Mon 02:30" },
      { key: "AR17", name: "B2B Win/Loss Eval (Auto Research)", schedule: "Weekly Mon 03:00" },
      { key: "AR18", name: "SEO Keyword Analyzer Eval (Auto Research)", schedule: "Weekly Mon 03:30" },
      { key: "AR19", name: "SEO Content Gap Eval (Auto Research)", schedule: "Weekly Mon 04:00" },
      { key: "AR20", name: "DTC Post-Purchase Eval (Auto Research)", schedule: "Weekly Mon 04:30" },
      { key: "AR21", name: "DTC Cart Recovery Eval (Auto Research)", schedule: "Weekly Mon 05:00" },
      { key: "AR22", name: "Supply Demand Forecast Eval (Auto Research)", schedule: "Weekly Mon 05:30" },
      { key: "AR23", name: "FinOps Reconciler Eval (Auto Research)", schedule: "Weekly Mon 06:00" },
      { key: "AR24", name: "FinOps Cash Flow Eval (Auto Research)", schedule: "Weekly Mon 06:30" },
      { key: "AR25", name: "FinOps P&L Eval (Auto Research)", schedule: "Weekly Mon 07:00" },
      { key: "AR26", name: "Social Engagement Eval (Auto Research)", schedule: "Weekly Mon 07:30" },
      { key: "AR27", name: "Social Analysis Eval (Auto Research)", schedule: "Weekly Mon 08:00" },
      { key: "AR28", name: "B2B Re-engagement Eval (Auto Research)", schedule: "Weekly Mon 08:30" },
    ],
  },
];
