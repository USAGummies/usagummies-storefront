...
export const ENGINE_REGISTRY: EngineConfig[] = [
  ...
  },
  {
    ...
    agents: [
      ...
      { key: "evening-brief", name: "Evening Company Brief", schedule: "Daily 21:00" },
      { key: "evening-recon", name: "Evening Recon", schedule: "Daily 21:30" },
      { key: "self-monitor", name: "Self-Monitor Health Check", schedule: "Daily 07:00" },
      { key: "signal-scan", name: "Signal Detection Scan", schedule: "Every 30 min" },
      { key: "dashboard-push", name: "Dashboard Push", schedule: "Every 6 hours" },
      { key: "vendor-followup", name: "Vendor Follow-Up", schedule: "Daily 09:00" },
      { key: "bank-auto-tagger", name: "Bank Transaction Auto-Tagger", schedule: "Every 60 min" },
      { key: "daily-pnl", name: "Daily P&L Snapshot", schedule: "Daily 07:30" },
      { key: "triple-recon", name: "Triple Reconciliation", schedule: "Daily 22:00" },
      { key: "qbo-health-sweep", name: "QBO Health Sweep", schedule: "Every 4 hours" },
      { key: "customer-intelligence", name: "Customer Intelligence", schedule: "Weekly Mon 09:00" },
      { key: "marketing-attribution", name: "Marketing Attribution", schedule: "Weekly Mon 10:00" },
      { key: "knowledge-base-builder", name: "Knowledge Base Builder", schedule: "Weekly Sun 22:00" },
      { key: "competitive-monitor", name: "Competitive Monitor", schedule: "Daily 12:00" },
    ],
  },
  {
    id: "abra-sync",
