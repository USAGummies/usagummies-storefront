...
These new versions will be made without FD&C (Food, Drug & Cosmetic) color additives — the synthetic dyes like [Red 40](/blog/is-red-40-bad-for-you), [Yellow 5 and Yellow 6](/blog/yellow-5-yellow-6-side-effects), and [Blue 1](/blog/blue-1-dye-in-candy) that currently give these candies their signature colors.
...
**Looking for gummy bears with no artificial dyes?** [Shop USA Gummies](/shop) — made in the USA with real fruit colors, no Red 40, and no synthetic dyes.
