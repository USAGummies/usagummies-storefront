...
Required HubSpot fields per active prospect / deal (uses existing standard fields + custom properties; **no schema mutation here, just standardize what we populate**):
