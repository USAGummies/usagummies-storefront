...
Per `/contracts/email-agents-system.md` §6. **Status: 🟢 37.1 + 37.2 + 37.3 + 37.4 + 37.7 SHIPPED · 37.5/37.6/37.8–37.16 queued.** Ships INSIDE Viktor as workflow lanes (no new runtime agent).
